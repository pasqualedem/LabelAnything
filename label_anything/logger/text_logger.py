...
class AutoLoggerConfig:
    ...
    def _setup_default_logging(self, log_level: str = None) -> None:
        ...
        experiment dir yet.
        The default log directory will be `~/ezdl_logs`
        ...
        self._setup_logging(
            filename=os.path.expanduser(
                f"~/ezdl_logs/ezdl_logs_{os.getppid()}_{timestamp}.log"
            ),
    ...
    def _setup_logging(
        self,
        filename: str,
        copy_already_logged_messages: bool,
        filemode: str = "a",
        log_level: str = None,
    ) -> None:
        """
    ...
    def get_instance(cls):
        global _ez_logger_config
        if _ez_logger_config is None:
            _ez_logger_config = cls()
            _ez_logger_config._setup_default_logging()

        return _ez_logger_config
